Feature: Course enrollment
    ...
    Scenario: Student successfully enrolls to course
        ...
        And "Advanced Programming" show up on my time table

    Scenario: Student tries to enroll to a filled out course
        Given I am logged in as username "student3" and password "some-password"
        And I have completed dependent course "Basic Programming"
        And "Advanced Programming" has reached max capacity
        When I attempt to enroll in "Advanced Programming"
        Then "Advanced Programming" student count should stay the same
        And I should see an error message that reads "This course has reached max capacity"

    Scenario: Student tries to enroll in a course that requires another course
        Given I am logged in as username "student3" and password "some-password"
        And I have not completed dependent course "Basic Programming"
        And "Advanced Programming" has not reached max capacity
        When I attempt to enroll in "Advanced Programming"
        Then "Advanced Programming" student count should stay the same
        And I should see an error message that reads "You must complete the course 'Basic Programming' first"
